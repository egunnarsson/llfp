...
public:
    ...
    virtual const TypeInstance* getFieldType(const std::string& constructor, unsigned int index) const;
...
public:
    ...
    void setFields(std::vector<TypeInstPtr> fieldTypes);
};
